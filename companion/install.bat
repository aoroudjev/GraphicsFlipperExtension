...
set REG_KEY=HKCU\Software\Microsoft\Edge\NativeMessagingHosts\com.gpuflip.toggle
...
if %errorlevel% == 0 (
  ...
  echo  5. Open gpu_toggle.json and replace EXTENSION_ID_PLACEHOLDER with that ID
